...
export const TRANSLATIONS: Record<LangCode, Translations> = {
  en: {
    ...
    tutorial: {
      ...
      windTitle: 'Watch Out for Wind!',
      windDesc: 'Wind zones push your candies sideways. Draw angled lines to counter the drift.',
      next: 'Next',
      play: 'Play!',
    },
    gameOver: {
  ...
  tr: {
    ...
    tutorial: {
      ...
      windTitle: 'Rüzgara Dikkat!',
      windDesc: 'Rüzgar bölgeleri şekerleri yana iter. Sürüklenmeyi dengelemek için eğik çizgiler çiz.',
      next: 'İleri',
      play: 'Oyna!',
    },
    gameOver: {
  ...
  es: {
    ...
    tutorial: {
      ...
      windTitle: '¡Cuidado con el Viento!',
      windDesc: 'Las zonas de viento empujan los dulces hacia los lados. Dibuja líneas inclinadas para contrarrestarlo.',
      next: 'Siguiente',
      play: '¡Jugar!',
    },
    gameOver: {
  ...
  fr: {
    ...
    tutorial: {
      ...
      windTitle: 'Attention au Vent !',
      windDesc: 'Les zones de vent poussent les bonbons sur le côté. Dessine des lignes inclinées pour compenser.',
      next: 'Suivant',
      play: 'Jouer !',
    },
    gameOver: {
  ...
  de: {
    ...
    tutorial: {
      ...
      windTitle: 'Achtung: Wind!',
      windDesc: 'Windzonen schieben Bonbons seitwärts. Zeichne schräge Linien, um die Drift auszugleichen.',
      next: 'Weiter',
      play: 'Spielen!',
    },
    gameOver: {
  ...
  it: {
    ...
    tutorial: {
      ...
      windTitle: 'Attenzione al Vento!',
      windDesc: 'Le zone di vento spingono le caramelle di lato. Disegna linee inclinate per contrastare la corrente.',
      next: 'Avanti',
      play: 'Gioca!',
    },
    gameOver: {
  ...
  pt: {
    ...
    tutorial: {
      ...
      windTitle: 'Cuidado com o Vento!',
      windDesc: 'Zonas de vento empurram os doces de lado. Desenhe linhas inclinadas para compensar.',
      next: 'Próximo',
      play: 'Jogar!',
    },
    gameOver: {
  ...
  ru: {
    ...
    tutorial: {
      ...
      windTitle: 'Осторожно: Ветер!',
      windDesc: 'Ветровые зоны сдувают конфеты в сторону. Рисуй наклонные линии, чтобы компенсировать.',
      next: 'Далее',
      play: 'Играть!',
    },
    gameOver: {
  ...
  uk: {
    ...
    tutorial: {
      ...
      windTitle: 'Обережно: Вітер!',
      windDesc: 'Вітрові зони здувають цукерки вбік. Малюй похилі лінії, щоб компенсувати.',
      next: 'Далі',
      play: 'Грати!',
    },
    gameOver: {
  ...
  ja: {
    ...
    tutorial: {
      ...
      windTitle: '風に注意！',
      windDesc: '風ゾーンがキャンディを横に押します。傾けた線を引いて流れを抑えましょう。',
      next: '次へ',
      play: 'プレイ！',
    },
    gameOver: {
